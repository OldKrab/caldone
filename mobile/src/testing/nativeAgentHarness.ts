...
export function nativeAgentHarness(
  ...
  const sources: Record<string, string> = {
    ...
    'expo-notifications': `export const setNotificationHandler=()=>{};export const getPermissionsAsync=async()=>({granted:globalThis.__nativeAgent.notificationPermission});
      export const scheduleNotificationAsync=async n=>{globalThis.__nativeAgent.notifications.push(n)};`,
